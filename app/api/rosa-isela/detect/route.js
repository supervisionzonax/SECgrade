...
export async function POST(request) {
	...
	try {
		...
		// Patrones específicos de ZipGrade:
		// Stu1, Stu2, ... Stu30 (respuestas del estudiante)
		// Points1, Points2, ... Points30 (puntos: 1 o 0)
		// Mark1, Mark2, ... Mark30 (marca: C o X)
		// PriKey1, PriKey2, ... PriKey30 (respuesta correcta)
